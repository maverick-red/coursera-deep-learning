...
def create_training_example(background, activates, negatives):
    ...
    for random_activate in random_activates:
        ...
        background, segment_time = insert_audio_clip(audio_clip=random_activate, background=background, previous_segments=previous_segments)
    ...
    for random_negative in random_negatives:
        # Insert the audio clip on the background 
        background, _ = insert_audio_clip(audio_clip=random_negative, background=background, previous_segments=previous_segments)
    ### END CODE HERE ###
